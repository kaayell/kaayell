...
export default function CreationDetailPage({creation}: CreationDetailPageProps) {
	...
	const relatedAssets = creation.related_assets ? [...[creation], ...creation.related_assets] : [creation];
			...
			>
				...
				>
					<div className="max-w-lg mx-auto">
						<div className="mb-8">
							<h2 className="text-3xl md:text-4xl font-bold mb-2">{creation.display_name}</h2>
						</div>
